...
@Autonomous(name="Basic Mini Bot Tank No Color Sensor", group="Au@to")
//@Disabled
...
public class BasicMiniBotTankNoColorSensor extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gyroDrive(DRIVE_SPEED*0.8, 55.0, 0.0, 10);
        gyroTurn(TURN_SPEED,90,3);
        gyroDrive(DRIVE_SPEED*0.8,25,90,3);
        gyroTurn(TURN_SPEED,180,3);
        gyroDrive(DRIVE_SPEED*0.8,55,180,3);
        gyroTurn(TURN_SPEED,-90,3);
        gyroDrive(DRIVE_SPEED*0.8,25,270,3);
        gyroTurn(TURN_SPEED,360,3);
